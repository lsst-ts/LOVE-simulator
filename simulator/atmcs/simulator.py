...
async def simulation_step(
    ...
    r.cmd_trackTarget.set(azimuth=azimuth+azimuthMax/trackingLoops*loop_count, azimuthVelocity=3,
                            elevation=elevation+elevationMax/trackingLoops*loop_count, elevationVelocity=3,
                            nasmyth1_rotator_angle=nasmyth1_rotator_angle+nasmyth1_rotator_angle_max/trackingLoops*loop_count, nasmyth1_rotator_angleVelocity=3,
                            nasmyth2_rotator_angle=nasmyth2_rotator_angle+nasmyth2_rotator_angleMax/trackingLoops*loop_count, nasmyth2_rotator_angleVelocity=3,
